...
public class OpenFromRightPopupwindow extends BasePopUpWindow2 {
    ...
    public OpenFromRightPopupwindow(Context context) {
        ...
        setproPortion(0.5f);
        setLayout(context, R.layout.popup_window_open_from_right,BasePopUpWindow2.TANS_HOR_FROM_RIGHT);
